...
final class LessThanOperatorImpl extends AbstractOperator {

	private static final Logger lgr = LogManager.getLogger(LessThanOperatorImpl.class.getName());
	private static LessThanOperatorImpl operatorImpl = null;
	private LessThanOperatorImpl() {}

	static LessThanOperatorImpl getInstance() {
		if (null == operatorImpl) {
			operatorImpl = new LessThanOperatorImpl();
		}
		return operatorImpl;
	}
