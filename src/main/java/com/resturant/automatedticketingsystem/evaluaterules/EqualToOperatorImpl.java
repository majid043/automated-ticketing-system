...
final class EqualToOperatorImpl extends AbstractOperator {

	private static final Logger lgr = LogManager.getLogger(EqualToOperatorImpl.class.getName());
	private static EqualToOperatorImpl operatorImpl = null;
	private EqualToOperatorImpl() {}

	static EqualToOperatorImpl getInstance() {
		if (null == operatorImpl) {
			operatorImpl = new EqualToOperatorImpl();
		}
		return operatorImpl;
	}
