...
final class GreaterThanEqualToOperatorImpl extends AbstractOperator {

	private static final Logger lgr = LogManager.getLogger(GreaterThanEqualToOperatorImpl.class.getName());
	private static GreaterThanEqualToOperatorImpl operatorImpl = null;
	private GreaterThanEqualToOperatorImpl() {}

	static GreaterThanEqualToOperatorImpl getInstance() {
		if (null == operatorImpl) {
			operatorImpl = new GreaterThanEqualToOperatorImpl();
		}
		return operatorImpl;
	}
